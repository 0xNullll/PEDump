...
void print_help(void) {
    printf(
        ...
        "\n"
        "                                               Examples:\n"
        "                                                   pedumper -h file@sha512                  sample.exe\n"
        "                                                   pedumper -h section:.text@sha512_256     sample.exe\n"
        "                                                   pedumper -h section:#2@sha224            sample.exe\n"
        "                                                   pedumper -h section:rva/0x401000@sha256  sample.exe\n"
        "                                                   pedumper -h section:fo/0x200@md5         sample.exe\n"
        "                                                   pedumper -h range:0x200-0x400@sha512_224 sample.exe\n"
        "                                                   pedumper -h range:512-1024@sha384        sample.exe\n"
        ...
        "\n"
        "                                               Examples:\n"
        "                                                   pedumper -cc file::file@sha512_256                       sample1.exe sample2.exe\n"
        "                                                   pedumper -cc section:.text::section:.rdata@sha512        sample1.exe sample2.exe\n"
        "                                                   pedumper -cc range:0x100-0x200::range:0x300-0x400@sha224 sample1.exe sample2.exe\n"
        "                                                   pedumper -cc section:.text::range:0x400-0x600@sha256     sample1.exe sample2.exe\n"
        "                                                   pedumper -cc section:#2::section:#3@sha512_224           sample1.exe sample2.exe\n"
        "                                                   pedumper -cc richheader::richheader@sha384               sample1.exe sample2.exe\n"
        "                                                   pedumper -cc section:.text::section:.rdata@md5           sample.exe   (compare within same file)\n"
        "\n"
    );
}
