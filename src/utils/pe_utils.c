...
void print_help(void) {
    printf(
        ...
        "\n"
        "                                               Examples:\n"
        "                                                   pedumper -h file@sha256              sample.exe\n"
        "                                                   pedumper -h section:.text@sha256     sample.exe\n"
        "                                                   pedumper -h section:#2@md5           sample.exe\n"
        "                                                   pedumper -h section:rva/0x401000     sample.exe\n"
        "                                                   pedumper -h section:fo/0x200@sha256  sample.exe\n"
        "                                                   pedumper -h range:0x200-0x400@sha256 sample.exe\n"
        "                                                   pedumper -h range:512-1024@md5       sample.exe\n"
        "                                                   pedumper -h range:0x1000-0x1800@sha1 sample.exe\n"
        "                                                   pedumper -h richheader@sha256        sample.exe\n"
        "\n"
        ...
        "\n"
        "                                               Examples:\n"
        "                                                   pedumper -cc file::file@sha256                        sample1.exe sample2.exe\n"
        ...
        "                                                   pedumper -cc richheader::richheader@sha256            sample1.exe sample2.exe\n"
        "                                                   pedumper -cc section:.text::section:.rdata            sample.exe   (compare within same file)\n"
        "\n"
    );
}
