...
void print_help(void) {
    printf(
        "# pedumper -h\n"
        "\n"
        "Usage: pedumper [options] file <file2>\n"
        "Options:\n"
        ...
        "\n"
        "  -hf,  --hash-file <alg>                     Compute hash of the entire file\n"
        "                                              <alg> can be: md5, sha1, sha256\n"
        "                                              Examples:\n"
        "                                                  pedumper -hf md5    sample.exe\n"
        "                                                  pedumper -hf sha256 sample.exe\n"
        "\n"
        "  -hs,  --hash-section <target[:alg]>         Compute hash of a section or part of the file\n"
        "                                              Targets follow the same spec as --extract:\n"
        "                                                  section:NAME      e.g., section:.text\n"
        "                                                  section:#IDX      e.g., section:#2\n"
        "                                                  section:rva/VAL   e.g., section:rva/0x401000\n"
        "                                                  section:fo/VAL    e.g., section:fo/0x200\n"
        "                                              Optional algorithm: :md5 | :sha1 | :sha256\n"
        "                                              Examples:\n"
        "                                                  pedumper -hs section:.text:sha256      sample.exe\n"
        "                                                  pedumper -hs section:#2:md5            sample.exe\n"
        "                                                  pedumper -hs section:rva/0x401000:sha1 sample.exe\n"
        "                                                  pedumper -hs section:fo/0x200:sha256   sample.exe\n"
        "\n"
        "  -hr,  --hash-range <start-end[:alg]>        Compute hash of an arbitrary file range\n"
        "                                              start-end can be hex (0x...) or decimal\n"
        "                                              Optional algorithm: :md5 | :sha1 | :sha256\n"
        "                                              Examples:\n"
        "                                                  pedumper -hr 0x200-0x400:sha256 sample.exe\n"
        "                                                  pedumper -hr 512-1024:md5       sample.exe\n"
        "                                                  pedumper -hr 0x1000-0x1800:sha1 sample.exe\n"
        "\n"
        "  -cc,  --compare-targets <target1>::<target2[:alg]>\n"
        "                                              Compare two targets between two files\n"
        "                                              Use '::' to separate the two targets (file1::file2)\n"
        "                                              Targets follow the same spec as --extract:\n"
        "                                                  section:NAME, section:#IDX, section:rva/VAL, section:fo/VAL\n"
        "                                                  range:start-end\n"
        "                                              Optional algorithm: :md5 | :sha1 | :sha256 (default: md5)\n"
        "                                              Examples:\n"
        "                                                  pedumper -cc section:.text::section:.rdata:sha256     sample1.exe sample2.exe\n"
        "                                                  pedumper -cc range:0x100-0x200::range:0x300-0x400:md5 sample1.exe sample2.exe\n"
        "                                                  pedumper -cc section:.text::range:0x400-0x600:sha1    sample1.exe sample2.exe\n"
        "                                                  pedumper -cc section:#2::section:#3:sha256            sample1.exe sample2.exe\n"
    "\n"
    );
}
